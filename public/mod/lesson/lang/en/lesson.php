...
$string['skinaccentcolour'] = 'Accent colour';
$string['skinaccentcolour_desc'] = 'Optional accent colour used for borders, highlights and visual emphasis in this lesson skin.';
$string['skinanswerbackgroundcolour'] = 'Answer background colour';
$string['skinanswerbackgroundcolour_desc'] = 'Optional background colour used for answer choices in this lesson skin.';
$string['skinbackgroundcolour'] = 'Background colour';
$string['skinbackgroundcolour_desc'] = 'Optional background colour used for the lesson page area in this lesson skin.';
$string['skinbackgroundimage'] = 'Background image';
$string['skinbackgroundimage_desc'] = 'Optional image used as the page background for this lesson skin.';
$string['skin_cards'] = 'Cards';
$string['skin_ocean'] = 'Ocean';
$string['skin_roman'] = 'Roman';
$string['skin_standard'] = 'Standard';
$string['skinsettings'] = 'Lesson skins';
$string['skinsettings_desc'] = 'Configure the built-in lesson skins. Teachers choose a skin in each Lesson activity; these settings define the shared images and colours for those skins.';
$string['skinsettingstemplate'] = '{$a} skin';
