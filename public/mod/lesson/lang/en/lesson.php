...
$string['lessonbackgroundimage'] = 'Lesson background image';
$string['lessonbackgroundimage_help'] = 'An optional image used as the skin background. When uploaded, it is shown instead of the skin background colour.';
$string['lessonimage'] = 'Lesson layout image';
$string['lessonimage_help'] = 'An optional image that skins can display in the lesson layout. Skin templates can use {{#hasimage}}, {{imageurl}} and {{imagealt}} to place it.';
$string['lessonimagealt'] = 'Image for {$a}';
...
$string['skin_chaos'] = 'Chaos';
$string['skin_ocean'] = 'Ocean';
$string['skin_roman'] = 'Roman';
$string['skin_standard'] = 'Standard';
$string['skinaccentcolor'] = 'Accent colour';
$string['skinanswerbackgroundcolor'] = 'Answer background colour';
$string['skinbackgroundcolor'] = 'Background colour';
$string['skincontentbackgroundcolor'] = 'Content background colour';
$string['skincustomcss'] = 'Custom CSS';
$string['skincustomcss_help'] = 'CSS applied when this skin is selected. Prefix selectors with .path-mod-lesson.lesson-skin-SKINNAME to keep styles scoped to this skin.';
$string['skinfontfamily'] = 'Font family';
$string['skinfontfamily_help'] = 'CSS font-family value used by this skin, for example Arial, sans-serif.';
$string['skininvalidcolour'] = 'Use a hex colour such as #ffcc00.';
$string['skinlayout'] = 'Layout';
$string['skinname'] = 'Skin name';
$string['skinname_help'] = 'A unique machine name using letters, numbers, underscores or hyphens. The name is stored on Lesson activities.';
$string['skinnametaken'] = 'This skin name is already in use.';
$string['skintemplate'] = 'Mustache layout template';
$string['skintemplate_help'] = 'Mustache template used to arrange Lesson page regions. Available regions include {{{globalnavigation}}}, {{{attemptheading}}}, {{{score}}}, {{{maincontentanchor}}}, {{{content}}} and {{{progress}}}. Lesson layout images are available as {{#hasimage}}, {{imageurl}} and {{imagealt}}.';
$string['skintitle'] = 'Display name';
$string['addlessonskin'] = 'Add Lesson skin';
$string['cannotdeleteskininuse'] = 'This Lesson skin is used by one or more Lesson activities and cannot be deleted.';
$string['cannotdeletestandardskin'] = 'The standard Lesson skin cannot be deleted.';
$string['deletelessonskin'] = 'Delete Lesson skin: {$a}';
$string['deletelessonskinconfirm'] = 'Are you sure you want to delete the Lesson skin "{$a}"?';
$string['editlessonskin'] = 'Edit Lesson skin: {$a}';
$string['managelessonskins'] = 'Lesson skins';
$string['nolessonskins'] = 'No Lesson skins have been created yet.';
