...
$string['skintemplate_help'] = 'Mustache template used to arrange Lesson page regions. Available regions include {{{globalnavigation}}}, {{{attemptheading}}}, {{{score}}}, {{{maincontentanchor}}}, {{{content}}} and {{{progress}}}.';
